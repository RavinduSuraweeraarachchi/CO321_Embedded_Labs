...
// Question:
/*
    Write a C function called usart_init to initialize the USART to work at 9600
    baud, 8-bit data, no parity, and 1 stop bit.

    Write a function called usart_send to transmit a character given as the
    argument.

    Write a function called usart_receive that returns a received character from
    the USART.
